...
.cinematic-footer-wrapper {
  ...
  /* Dynamic Variables using standard shadcn/tailwind v4 tokens wrapped in hsl() */
...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Website Profesional</span> <span className="text-primary/60">✦</span>
    <span>Sistem Terintegrasi</span> <span className="text-secondary/60">✦</span>
    <span>Desain Premium</span> <span className="text-primary/60">✦</span>
    <span>SEO Friendly</span> <span className="text-secondary/60">✦</span>
    <span>Performa Cepat</span> <span className="text-primary/60">✦</span>
  </div>
);
      ...
      */}
      ...
      >
        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper">
          ...
          <div className="relative z-20 w-full pb-8 pl-6 pr-24 md:pl-12 md:pr-32 flex flex-col md:flex-row items-center justify-between gap-6">
