        ...
        {loading && (
          ...
          >
            ...
            >
              ...
              <img src="/light/logo-text-nobg.png" alt="Nitisaka" className="h-14 w-auto block dark:hidden" />
              <img src="/dark/logo-text-nobg.png" alt="Nitisaka" className="h-14 w-auto hidden dark:block" />
