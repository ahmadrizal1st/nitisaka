        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative mt-12 lg:mt-0">
            ...
            <div className="absolute top-0 lg:top-1/4 left-1/2 -translate-x-1/2 w-full h-full z-0 flex items-start justify-center opacity-80 lg:opacity-100 pointer-events-none">
              <img 
                src="/illustrations/nitisaka-about-mascot.webp" 
                srcSet="/illustrations/nitisaka-about-mascot.webp 418w, /illustrations/nitisaka-about-mascot@2x.webp 836w"
                sizes="(max-width: 1024px) 836px, 418px"
                alt="Nitisaka About Mascot" 
                width="418"
                height="278"
                loading="lazy"
                decoding="async"
                className="w-full max-w-[120%] lg:w-[110%] lg:max-w-[110%] h-auto object-contain scale-110 -mt-12 md:-mt-16 lg:-mt-24"
              />
            </div>
