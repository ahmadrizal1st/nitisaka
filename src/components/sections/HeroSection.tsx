  ...
  <div className="flex flex-col h-full w-full bg-background overflow-hidden">
    ...
    <div className="flex items-center gap-2 px-4 py-3 border-b border-border bg-muted/50">
      ...
      <div className="flex-1 flex justify-center">
        <img src="/light/logo-text-nobg.webp" alt="Nitisaka Logo" className="h-4 w-auto block dark:hidden opacity-90" width="41" height="16" />
        <img src="/dark/logo-text-nobg.webp" alt="Nitisaka Logo" className="h-4 w-auto hidden dark:block opacity-90" width="41" height="16" />
      </div>
