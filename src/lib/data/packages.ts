...
export const packageCategories: PackageCategory[] = [
  ...
  },
  {
    ...
    icon: "TrendingUp",
    description:
      "Layanan optimasi mesin pencari untuk meningkatkan visibilitas website",
    packages: [
      {
        id: "seo-starter",
        name: "Starter",
        ...
        priceMin: 500000,
        description: "Dasar optimasi SEO untuk website",
        features: [
          "Audit SEO website",
          "Optimasi meta title & description",
          "Setup XML sitemap & robots.txt",
      ...
      },
      {
        ...
        priceMin: 1000000,
        description: "Optimasi SEO lengkap untuk hasil maksimal",
        popular: true,
        features: [
          "Semua fitur Starter, plus:",
          "Optimasi heading structure (H1-H6)",
          "Google Search Console setup",
          "Analisis keyword (10 keyword)",
      ...
      },
      {
        ...
        priceRange: "Rp 2.000.000",
        priceMin: 2000000,
        description: "SEO premium dengan strategi lengkap",
        features: [
          "Semua fitur Business, plus:",
          ...
          "Advanced keyword research (20 keyword)",
          "Weekly ranking monitoring",
          "Priority support 2 jam/bulan",
        ],
      },
    ],
  },
